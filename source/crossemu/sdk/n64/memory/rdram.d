module crossemu.sdk.n64.memory.rdram;
    ...
    */
    struct N64RdRam
    {
        ...
        */
        ...
        ref N64RdRam opAssign(uint addr) return {
            this.address = addr;
            return this;
        }
        ...
        static:
            alias ptr     = g_n64_rdram_ptr;
            alias length  = g_n64_rdram_len;
            alias logging = g_n64_rdram_logging;
        ...
        public:
            ...
            T read(T)(uint addr)
            {
                static if (isSomeString!T)
                {
                    ...
                    return cast(T) text(cast(const char*)
                        crossemu_sdk_n64_rdram_read_str(addr));
                }
                else static if (isNumeric!T)
                {
                    T value; 
                    if (!crossemu_sdk_n64_rdram_read_val(addr, &value, T.sizeof))
                        return cast(T) 0;
                    return value;
                }
            }
            ...
            */
            ...
            {
                void* value;
                value = crossemu_sdk_n64_rdram_read_arr(addr, size);
            ...
            */
            ...
            {
                void* value;
                value = crossemu_sdk_n64_rdram_read_ptr_raw(addr, size);
            ...
            */
            bool write(T)(uint addr, T value)
            {
                static if (isSomeString!T)
                {
                    ...
                    return crossemu_sdk_n64_rdram_write_str(
                        addr, toStringz(cast(string) value));
                }
                else static if (isNumeric!T)
                {
                    return crossemu_sdk_n64_rdram_write_val(
                        addr, &value, T.sizeof);
                }
            }
            ...
            */
            ...
            {
                return crossemu_sdk_n64_rdram_write_arr(
            ...
            */
            ...
            {
                return crossemu_sdk_n64_rdram_write_raw(
                    addr, cast(void*) value.ptr(), value.length);
            }
    }
...
export extern(C):
    ...
    // global variables
    static void*   g_n64_rdram_ptr;
    static size_t  g_n64_rdram_len;
    static bool    g_n64_rdram_logging;

    // non-native accessors
    void*  crossemu_sdk_n64_rdram_get_ptr() { return g_n64_rdram_ptr; }
    void   crossemu_sdk_n64_rdram_set_ptr(void* address) { g_n64_rdram_ptr = address; }
    
    size_t crossemu_sdk_n64_rdram_get_len() { return g_n64_rdram_len; }
    void   crossemu_sdk_n64_rdram_set_len(size_t size) { g_n64_rdram_len = size; }
    
    bool   crossemu_sdk_n64_rdram_get_logging() { return g_n64_rdram_logging; }
    void   crossemu_sdk_n64_rdram_set_logging(bool enabled) { g_n64_rdram_logging = enabled; }

    // vmem callbacks
    bool crossemu_sdk_n64_rdram_check_bounds(uint addr, size_t size)
    {
        size_t check  = addr + size;
        size_t offset = 0x80000000;
        if (
            offset <= check &&
            check <= offset + g_n64_rdram_len
        ) return true;
    ...
    void crossemu_sdk_n64_rdram_memlog(uint addr, void* value, const(char*) type)
    {
        // import std.conv : text;

        // auto msg = "N64RdRam.write!%s(%s, %s)";
    ...
    */
    bool crossemu_sdk_n64_rdram_read_ptr_val(uint addr, uint ptr_offset, void* value, size_t size)
    {
        return crossemu_sdk_n64_vmem_read_ptr_val(
            addr, ptr_offset, value, size, g_n64_rdram_ptr,
            &crossemu_sdk_n64_rdram_check_bounds
        );
    }
    ...
    *      size  = The size of the variable being passed.
    */
    bool crossemu_sdk_n64_rdram_read_val(uint addr, void* value, size_t size)
    {
        return crossemu_sdk_n64_vmem_read_val(
            addr, value, size, g_n64_rdram_ptr,
            &crossemu_sdk_n64_rdram_check_bounds
        );
    }
    ...
    *      ptr_offset = The offset inside the (assumed) struct that addr points to.
    */
    char* crossemu_sdk_n64_rdram_read_ptr_str(uint addr, uint ptr_offset)
    {
        return crossemu_sdk_n64_vmem_read_ptr_str(
            addr, ptr_offset, g_n64_rdram_ptr,
            &crossemu_sdk_n64_rdram_check_bounds
        );
    }
    ...
    *      addr = The location where memory starts.
    */
    char* crossemu_sdk_n64_rdram_read_str(uint addr)
    {
        return crossemu_sdk_n64_vmem_read_str(
            addr, g_n64_rdram_ptr,
            &crossemu_sdk_n64_rdram_check_bounds
        );
    }
    ...
    */
    void* crossemu_sdk_n64_rdram_read_ptr_arr(uint addr, uint ptr_offset, size_t size)
    {
        return crossemu_sdk_n64_vmem_read_ptr_arr(
            addr, ptr_offset, size, g_n64_rdram_ptr,
            &crossemu_sdk_n64_rdram_check_bounds
        );
    }
    ...
    *      size = The length of data to return.
    */
    void* crossemu_sdk_n64_rdram_read_arr(uint addr, size_t size)
    {
        return crossemu_sdk_n64_vmem_read_arr(
            addr, size, g_n64_rdram_ptr,
            &crossemu_sdk_n64_rdram_check_bounds
        );
    }
    ...
    *      size       = The length of data to return.
    */
    void* crossemu_sdk_n64_rdram_read_ptr_raw(uint addr, uint ptr_offset, size_t size)
    {
    ...
    *      size = The length of data to return.
    */
    void* crossemu_sdk_n64_rdram_read_raw(uint addr, size_t size)
    {
    ...
    *      size       = The size of the variable being passed.
    */
    bool crossemu_sdk_n64_rdram_write_ptr_val(uint addr, uint ptr_offset, void* value, size_t size)
    {
        return crossemu_sdk_n64_vmem_write_ptr_val(
            addr, ptr_offset, value, size, g_n64_rdram_ptr,
            &crossemu_sdk_n64_rdram_check_bounds,
            (g_n64_rdram_logging ? &crossemu_sdk_n64_rdram_memlog : null)
        );
    }
    ...
    *      size  = The size of the variable being passed.
    */
    bool crossemu_sdk_n64_rdram_write_val(uint addr, void* value, size_t size)
    {
    ...
    */
    bool crossemu_sdk_n64_rdram_write_ptr_str(uint addr, uint ptr_offset, const(char*) value)
    {
        return crossemu_sdk_n64_vmem_write_ptr_str(
            addr, ptr_offset, value, g_n64_rdram_ptr,
            &crossemu_sdk_n64_rdram_check_bounds,
            (g_n64_rdram_logging ? &crossemu_sdk_n64_rdram_memlog : null)
        );
    }
    ...
    *      value = The string data being passed.
    */
    bool crossemu_sdk_n64_rdram_write_str(uint addr, const(char*) value)
    {
        return crossemu_sdk_n64_vmem_write_str(
            addr, value, g_n64_rdram_ptr,
            &crossemu_sdk_n64_rdram_check_bounds,
            (g_n64_rdram_logging ? &crossemu_sdk_n64_rdram_memlog : null)
        );
    }
    ...
    */
    bool crossemu_sdk_n64_rdram_write_ptr_arr(uint addr, uint ptr_offset, void* value, size_t size)
    {
    ...
    *      size  = The size of the data being passed.
    */
    bool crossemu_sdk_n64_rdram_write_arr(uint addr, void* value, size_t size)
    {
    ...
    *      size       = The size of the data being passed.
    */
    bool crossemu_sdk_n64_rdram_write_ptr_raw(uint addr, uint ptr_offset, void* value, size_t size)
    {
    ...
    *      size  = The size of the data being passed.
    */
    bool crossemu_sdk_n64_rdram_write_raw(uint addr, void* value, size_t size)
    {
